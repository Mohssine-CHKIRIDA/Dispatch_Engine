...
public class RequestClosed {
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public RequestClosed(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, ClosedPayload payload) {
        super();
    ...
    public RequestClosed withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public RequestClosed withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public RequestClosed withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public RequestClosed withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public RequestClosed withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public RequestClosed withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public ClosedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(ClosedPayload payload) {
        this.payload = payload;
    }

    public RequestClosed withPayload(ClosedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequestClosed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestClosed) == false) {
            return false;
        }
        RequestClosed rhs = ((RequestClosed) other);
