...
public class RequestCaseEmbedded {
    ...
    @Valid
    @NotNull
    private CaseEmbeddedPayload payload;

    /**
     * No args constructor for use in serialization
     * 
     */
    public RequestCaseEmbedded() {
    }
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public RequestCaseEmbedded(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, CaseEmbeddedPayload payload) {
        super();
    ...
    public RequestCaseEmbedded withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public RequestCaseEmbedded withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public RequestCaseEmbedded withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public RequestCaseEmbedded withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public RequestCaseEmbedded withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public RequestCaseEmbedded withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public CaseEmbeddedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(CaseEmbeddedPayload payload) {
        this.payload = payload;
    }

    public RequestCaseEmbedded withPayload(CaseEmbeddedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequestCaseEmbedded.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestCaseEmbedded) == false) {
            return false;
        }
        RequestCaseEmbedded rhs = ((RequestCaseEmbedded) other);
