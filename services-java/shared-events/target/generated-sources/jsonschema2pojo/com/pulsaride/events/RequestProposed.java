...
public class RequestProposed {
    ...
    @Valid
    @NotNull
    private ProposedPayload payload;

    /**
     * No args constructor for use in serialization
     * 
     */
    public RequestProposed() {
    }
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public RequestProposed(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, ProposedPayload payload) {
        super();
    ...
    public RequestProposed withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public RequestProposed withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public RequestProposed withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public RequestProposed withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public RequestProposed withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public RequestProposed withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public ProposedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(ProposedPayload payload) {
        this.payload = payload;
    }

    public RequestProposed withPayload(ProposedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequestProposed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestProposed) == false) {
            return false;
        }
        RequestProposed rhs = ((RequestProposed) other);
