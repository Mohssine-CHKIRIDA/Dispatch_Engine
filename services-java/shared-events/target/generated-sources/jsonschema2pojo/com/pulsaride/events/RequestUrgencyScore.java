...
public class RequestUrgencyScore {
    ...
    @Valid
    @NotNull
    private UrgencyScorePayload payload;

    /**
     * No args constructor for use in serialization
     * 
     */
    public RequestUrgencyScore() {
    }
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public RequestUrgencyScore(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, UrgencyScorePayload payload) {
        super();
    ...
    public RequestUrgencyScore withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public RequestUrgencyScore withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public RequestUrgencyScore withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public RequestUrgencyScore withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public RequestUrgencyScore withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public RequestUrgencyScore withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public UrgencyScorePayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(UrgencyScorePayload payload) {
        this.payload = payload;
    }

    public RequestUrgencyScore withPayload(UrgencyScorePayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequestUrgencyScore.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestUrgencyScore) == false) {
            return false;
        }
        RequestUrgencyScore rhs = ((RequestUrgencyScore) other);
