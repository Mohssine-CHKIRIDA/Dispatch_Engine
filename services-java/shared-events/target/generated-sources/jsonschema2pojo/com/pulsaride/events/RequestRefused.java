...
public class RequestRefused {
    ...
    @Valid
    @NotNull
    private RefusedPayload payload;
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public RequestRefused(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, RefusedPayload payload) {
        super();
    ...
    public RequestRefused withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public RequestRefused withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public RequestRefused withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public RequestRefused withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public RequestRefused withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public RequestRefused withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public RefusedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(RefusedPayload payload) {
        this.payload = payload;
    }

    public RequestRefused withPayload(RefusedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequestRefused.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestRefused) == false) {
            return false;
        }
        RequestRefused rhs = ((RequestRefused) other);
