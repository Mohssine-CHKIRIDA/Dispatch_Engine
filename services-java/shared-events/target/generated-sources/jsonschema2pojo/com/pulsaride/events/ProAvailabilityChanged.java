...
public class ProAvailabilityChanged {
    ...
    @Valid
    @NotNull
    private AvailabilityChangedPayload payload;

    /**
     * No args constructor for use in serialization
     * 
     */
    public ProAvailabilityChanged() {
    }
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public ProAvailabilityChanged(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, AvailabilityChangedPayload payload) {
        super();
    ...
    public ProAvailabilityChanged withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public ProAvailabilityChanged withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public ProAvailabilityChanged withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public ProAvailabilityChanged withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public ProAvailabilityChanged withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public ProAvailabilityChanged withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public AvailabilityChangedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(AvailabilityChangedPayload payload) {
        this.payload = payload;
    }

    public ProAvailabilityChanged withPayload(AvailabilityChangedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ProAvailabilityChanged.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProAvailabilityChanged) == false) {
            return false;
        }
        ProAvailabilityChanged rhs = ((ProAvailabilityChanged) other);
