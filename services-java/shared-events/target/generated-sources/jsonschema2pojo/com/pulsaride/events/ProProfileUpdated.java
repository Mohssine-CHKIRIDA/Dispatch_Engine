...
public class ProProfileUpdated {
    ...
    @Valid
    @NotNull
    private ProfileUpdatedPayload payload;

    /**
     * No args constructor for use in serialization
     * 
     */
    public ProProfileUpdated() {
    }
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public ProProfileUpdated(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, ProfileUpdatedPayload payload) {
        super();
    ...
    public ProProfileUpdated withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public ProProfileUpdated withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public ProProfileUpdated withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public ProProfileUpdated withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public ProProfileUpdated withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public ProProfileUpdated withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public ProfileUpdatedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(ProfileUpdatedPayload payload) {
        this.payload = payload;
    }

    public ProProfileUpdated withPayload(ProfileUpdatedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ProProfileUpdated.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProProfileUpdated) == false) {
            return false;
        }
        ProProfileUpdated rhs = ((ProProfileUpdated) other);
