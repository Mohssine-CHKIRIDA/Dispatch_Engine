...
public class RequestAccepted {
    ...
    @Valid
    @NotNull
    private AcceptedPayload payload;
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public RequestAccepted(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, AcceptedPayload payload) {
        super();
    ...
    public RequestAccepted withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public RequestAccepted withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public RequestAccepted withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public RequestAccepted withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public RequestAccepted withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public RequestAccepted withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public AcceptedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(AcceptedPayload payload) {
        this.payload = payload;
    }

    public RequestAccepted withPayload(AcceptedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequestAccepted.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestAccepted) == false) {
            return false;
        }
        RequestAccepted rhs = ((RequestAccepted) other);
