...
public class RequestSubmitted {
    ...
    @Valid
    @NotNull
    private SubmittedPayload payload;
     ...
     *     Schema version for this event type, e.g. '1.0'. Bump on breaking changes so consumers can branch on it during migration.
     */
    public RequestSubmitted(UUID eventId, UUID requestId, Object eventType, String version, OffsetDateTime producedAt, String producer, SubmittedPayload payload) {
        super();
    ...
    public RequestSubmitted withEventId(UUID eventId) {
        this.eventId = eventId;
        return this;
    }
    ...
    public RequestSubmitted withRequestId(UUID requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public RequestSubmitted withEventType(Object eventType) {
        this.eventType = eventType;
        return this;
    }
    ...
    public RequestSubmitted withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public RequestSubmitted withProducedAt(OffsetDateTime producedAt) {
        this.producedAt = producedAt;
        return this;
    }
    ...
    public RequestSubmitted withProducer(String producer) {
        this.producer = producer;
        return this;
    }
     ...
     */
    @JsonProperty("payload")
    public SubmittedPayload getPayload() {
        return payload;
    }
     ...
     */
    @JsonProperty("payload")
    public void setPayload(SubmittedPayload payload) {
        this.payload = payload;
    }

    public RequestSubmitted withPayload(SubmittedPayload payload) {
        this.payload = payload;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequestSubmitted.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eventId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestSubmitted) == false) {
            return false;
        }
        RequestSubmitted rhs = ((RequestSubmitted) other);
